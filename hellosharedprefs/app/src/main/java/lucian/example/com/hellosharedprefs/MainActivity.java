package lucian.example.com.hellosharedprefs;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "lucian.example.com.hellosharedprefs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mColor = ContextCompat.getColor(this, R.color.default_background); //initialiser mColor a default background
        ...
        mColor = mPreferences.getInt(COLOR_KEY, mColor); //si la cle n'est pas retrouve, utiliser le mColor avec le default background
